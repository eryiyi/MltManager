...
<div id="wrapper">
    ...
    <div class="rightbox">
        ...
        <%--<ul class="linksteps">--%>
        <%--<h3>申请步骤:</h3>--%>
        <%--<li><i class="nums">1</i> 请先在贵网站做好中国苗连通网的文字友情链接, 链接文字： 中国苗连通网链接地址：http://www.cnhnb.com</li>--%>
        <%--<li><i class="nums">2</i>做好链接后，请填写申请信息。</li>--%>
        <%--<li><i class="nums">3</i>已经开通我站友情链接且内容健康，符合本站友情链接要求的网站，经中国苗连通网管理员审核后，可以显示在此友情链接页面。</li>--%>
        <%--</ul>--%>
        <%--<div class="servicebox">--%>
        <%--<p><strong>中国苗连通网客服热线:</strong></p>--%>
