...
<div class="type-head">
    <h1 class="logo">
        <a href="javascript:void(0)" title="苗联通信息平台"></a>
    </h1>
...
<div class="container wrap-1190">
    ...
    <form action="supply.htm" id="filterForm" class="fl" style="width: 956px;">
        <div class="noticebar mt_15">
            ...
            <span class="notice-msg"><a href="#" target="_blank" rel="nofollow">欢迎使用苗联通信息平台，请谨慎核实信息内容!</a></span>
        </div>
    ...
    <div class="sides mt_15">
        ...
        <div class="ad2">
            ...
            <a href="../html/download.html" target="_blank" title="苗联通app" rel="nofollow">
